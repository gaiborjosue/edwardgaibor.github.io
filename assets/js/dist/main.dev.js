...
sr.reveal('.project_card', {
  delay: 100
});
sr.reveal('.button_project', {
  delay: 100
});
/*SCROLL WORK*/
...
var typed = new Typed(".typing", {
  strings: ["Student from the IB.", "Junior Developer.", "Python Lover.", "Future CS major."],
  typeSpeed: 100,
  backSpeed: 60,
  loop: true
});
...
$(document).mousemove(function (event) {
  //verticalAxis
  mouseY = event.pageY;
  yAxis = (pageY / 2 - mouseY) / pageY * 300; //horizontalAxis
